...
import 'package:flutter/material.dart';
import 'package:flutter_echarts/flutter_echarts.dart';
import 'package:flutter_echarts/src/echarts_controller.dart'; // Ensure the controller is imported
import 'gl_script.dart' show glScript;
import 'parent.dart' as globals;
...
class _GraphState extends State<Graph> {
  late EchartsController _controller;
  ...
  void initState() {
    ...
    // Listen for BLE data changes
    globals.onBleDataChanged = () {
      // Update only the series data dynamically
      _controller.dispatchAction(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      child: Echarts(
        ...
        reloadAfterInit: false, // Prevent full reload on updates
      ),
      width: 300,
      height: 250,
    );
